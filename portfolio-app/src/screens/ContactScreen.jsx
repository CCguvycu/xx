...
export default function ContactScreen() {
  ...
  const available = links.filter((l) => !!l.href(social));
    ...
    <div className="screen contact-screen">
      ...
      <main className="scroll-body contact-body">
        {available.length === 0 ? (
          <div className="empty">
            ...
            <p className="empty-sub">
              Add your details in <code>src/data/profile.js</code>
            </p>
          </div>
        ) : (
              ...
              <li key={l.id}>
                ...
                >
                  ...
                  <span className="contact-text">
                    ...
                    <span className="contact-hint">{l.hint}</span>
                  </span>
        ...
        <p className="edit-hint">
          Edit <code>src/data/profile.js</code> to add your links
        </p>
